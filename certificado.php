...
<main>
                <center><img src="./img/imagem3.png"></center>
                <style> img{margin-top:30px;width:70%;height:40%;}</style><br>
                <center><button type="btn" class="ms-3 btn btn-success"><a href="index.php"style="text-decoration:none; color: white">Voltar</button></a></center>
                <style> .btn{width:10%;text-decoration: none;}</style>
